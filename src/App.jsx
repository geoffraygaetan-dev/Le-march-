...
const ISearch = () => <Svg d={<><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></>} />;

// ── Categories & constants ─────────────────────────────────────────────────
const CATS = [
  "🥦 Légumes", "🍎 Fruits", "🥩 Viande & Volaille", "🐟 Poisson & Fruits de mer",
  "🥐 Boulangerie", "🧀 Crémerie & Œufs", "🫙 Épicerie salée", "🍫 Épicerie sucrée",
  "❄️ Surgelés", "🧴 Hygiène & Beauté", "🍷 Boissons", "🧹 Entretien", "💊 Santé", "🌿 Autre"
];
...
const PRESETS = {
  ...
  "🥩 Viande & Volaille": [
    {n:"Steaks hachés",e:"🥩"},{n:"Poulet entier",e:"🍗"},{n:"Escalopes de poulet",e:"🍗"},
    {n:"Cordons bleus",e:"🐓"},{n:"Cuisses de poulet",e:"🍗"},{n:"Filet de bœuf",e:"🥩"},
    {n:"Côtelettes d'agneau",e:"🐑"},{n:"Rôti de porc",e:"🐷"},{n:"Lardons",e:"🥓"},
    {n:"Jambon blanc",e:"🥩"},{n:"Saucisses",e:"🌭"},{n:"Merguez",e:"🌶️"},
    {n:"Chipolatas",e:"🌭"},{n:"Bacon",e:"🥓"},{n:"Veau",e:"🐮"},{n:"Canard",e:"🦆"},
    {n:"Dinde",e:"🦃"},{n:"Rôti de bœuf",e:"🥩"},{n:"Entrecôte",e:"🥩"},{n:"Pâté",e:"🫙"},
  ],
  "🐟 Poisson & Fruits de mer": [
    {n:"Saumon",e:"🐟"},{n:"Thon",e:"🐠"},{n:"Cabillaud",e:"🐡"},{n:"Daurade",e:"🐟"},
    {n:"Crevettes",e:"🦐"},{n:"Moules",e:"🦪"},{n:"Coquilles St-Jacques",e:"🦪"},
    {n:"Lieu noir",e:"🐟"},{n:"Truite",e:"🐡"},{n:"Sardines",e:"🐟"},
    {n:"Anchois",e:"🐟"},{n:"Poulpe",e:"🐙"},{n:"Calamars",e:"🦑"},{n:"Huîtres",e:"🦪"},
    {n:"Langoustines",e:"🦐"},{n:"Crabe",e:"🦀"},
  ],
  "🥐 Boulangerie": [
    {n:"Pain de mie",e:"🍞"},{n:"Baguette",e:"🥖"},{n:"Croissants",e:"🥐"},{n:"Pains au chocolat",e:"🍫"},
    {n:"Brioche",e:"🍞"},{n:"Pain de campagne",e:"🫓"},{n:"Pains aux raisins",e:"🥐"},
    {n:"Ficelle",e:"🥖"},{n:"Muffins",e:"🧁"},{n:"Pains pita",e:"🫓"},
    {n:"Tortillas",e:"🫓"},{n:"Biscottes",e:"🍞"},
  ],
  "🧀 Crémerie & Œufs": [
  ...
  "🫙 Épicerie salée": [
    ...
    {n:"Ketchup",e:"🍅"},{n:"Mayonnaise",e:"🫙"},{n:"Sauce soja",e:"🍶"},{n:"Bouillon cube",e:"🟨"},
    {n:"Thon en boîte",e:"🐟"},{n:"Tomates pelées",e:"🍅"},{n:"Concentré de tomate",e:"🍅"},
    {n:"Haricots blancs",e:"🫘"},{n:"Cornichons",e:"🥒"},{n:"Olives",e:"🫒"},
    {n:"Curry",e:"🟡"},{n:"Paprika",e:"🔴"},{n:"Cumin",e:"🟤"},{n:"Herbes de Provence",e:"🌿"},
    {n:"Tabasco",e:"🌶️"},{n:"Semoule",e:"🌾"},{n:"Quinoa",e:"🌾"},
    {n:"Lasagnes",e:"🍝"},{n:"Tagliatelles",e:"🍝"},{n:"Nouilles chinoises",e:"🍜"},
  ],
  "🍫 Épicerie sucrée": [
    {n:"Sucre",e:"🍬"},{n:"Sucre glace",e:"⬜"},{n:"Chocolat noir",e:"🍫"},{n:"Chocolat au lait",e:"🍫"},
    {n:"Nutella",e:"🫙"},{n:"Confiture fraise",e:"🍓"},{n:"Confiture abricot",e:"🍑"},
    {n:"Miel",e:"🍯"},{n:"Sirop d'érable",e:"🍁"},{n:"Vanille",e:"🌿"},{n:"Levure chimique",e:"🧁"},
    {n:"Cacao",e:"🍫"},{n:"Céréales",e:"🌾"},{n:"Granola",e:"🥣"},{n:"Flocons d'avoine",e:"🌾"},
    {n:"Biscuits",e:"🍪"},{n:"Chips",e:"🥔"},{n:"Bonbons",e:"🍬"},{n:"Compote",e:"🍎"},
    {n:"Crèmes dessert",e:"🍮"},
  ],
  "❄️ Surgelés": [
    {n:"Petits pois surgelés",e:"🫛"},{n:"Épinards surgelés",e:"🌿"},{n:"Frites",e:"🍟"},
    {n:"Poisson pané",e:"🐟"},{n:"Pizza surgelée",e:"🍕"},{n:"Glaces",e:"🍦"},
    {n:"Fruits rouges surgelés",e:"🍓"},{n:"Wok de légumes",e:"🥦"},{n:"Nuggets",e:"🍗"},
    {n:"Crêpes",e:"🥞"},{n:"Crevettes surgelées",e:"🦐"},{n:"Tarte surgelée",e:"🥧"},
  ],
  "🧴 Hygiène & Beauté": [
    {n:"Shampooing",e:"🧴"},{n:"Après-shampooing",e:"🧴"},{n:"Gel douche",e:"🚿"},
    {n:"Savon",e:"🧼"},{n:"Dentifrice",e:"🦷"},{n:"Brosse à dents",e:"🪥"},
    {n:"Déodorant",e:"💨"},{n:"Rasoirs",e:"🪒"},{n:"Coton",e:"🌸"},
    {n:"Crème hydratante",e:"🧴"},{n:"Protections solaires",e:"☀️"},
    {n:"Papier toilette",e:"🧻"},{n:"Mouchoirs",e:"🤧"},{n:"Lingettes",e:"🧻"},
  ],
  "🍷 Boissons": [
    {n:"Eau minérale",e:"💧"},{n:"Eau gazeuse",e:"🫧"},{n:"Jus d'orange",e:"🍊"},
    {n:"Jus de pomme",e:"🍎"},{n:"Coca-Cola",e:"🥤"},{n:"Limonade",e:"🍋"},
    {n:"Bière",e:"🍺"},{n:"Vin rouge",e:"🍷"},{n:"Vin blanc",e:"🥂"},{n:"Rosé",e:"🌸"},
    {n:"Champagne",e:"🍾"},{n:"Café",e:"☕"},{n:"Thé",e:"🍵"},{n:"Tisane",e:"🌿"},
    {n:"Lait",e:"🥛"},{n:"Sirop",e:"🫙"},{n:"Smoothie",e:"🥤"},
  ],
  "🧹 Entretien": [
    {n:"Liquide vaisselle",e:"🧴"},{n:"Lessive",e:"👕"},{n:"Adoucissant",e:"🌸"},
    {n:"Nettoyant sol",e:"🧹"},{n:"Nettoyant multi-surfaces",e:"🧽"},{n:"Éponges",e:"🧽"},
    {n:"Sacs poubelle",e:"🗑️"},{n:"Papier alu",e:"🪙"},{n:"Film plastique",e:"🌀"},
    {n:"Liquide WC",e:"🚽"},{n:"Désinfectant",e:"🫧"},{n:"Pastilles lave-vaisselle",e:"✨"},
  ],
  "💊 Santé": [
...
export default function App() {
  ...
  const localRef                      = useRef(null); // to avoid write→read loop

  const [itemText, setItemText]       = useState("");
  const [itemCat, setItemCat]         = useState(CATS[0]);
  ...
  useEffect(() => {
    ...
    const unsub = onValue(dbRef, (snapshot) => {
      ...
      // Ensure arrays (Firebase may strip empty arrays)
      if (!d.items) d.items = [];
      if (!d.notes) d.notes = [];
  ...
  const addItem = (textOverride) => {
    const text = (textOverride || itemText).trim();
    if (!text) return;
    const stores = Object.entries(itemStores).filter(([, v]) => v).map(([k]) => k);
    if (!stores.length) return;
    const qty = itemQty && itemQty !== "1" ? `${itemQty} ${itemUnit}` : "";
    mutate(d => ({...d, items: [...(d.items||[]), {id: uid(), text, qty, cat: itemCat, stores, done: {}}]}));
    setItemText(""); setSearch("");
    if (!textOverride) inputRef.current?.focus();
  };

  const pickPreset = (name) => { setItemText(name); setSearch(""); inputRef.current?.focus(); };
  const toggleDone = (itemId, storeId) => mutate(d => ({...d, items: d.items.map(i => i.id===itemId ? {...i, done: {...(i.done||{}), [storeId]: !(i.done||{})[storeId]}} : i)}));
    ...
    <div style={{minHeight:"100vh",background:"#fdf6ec",fontFamily:"Lato,sans-serif",backgroundImage:"radial-gradient(circle at 15% 15%,#f9e8d0 0%,transparent 55%),radial-gradient(circle at 85% 85%,#e8f0e0 0%,transparent 55%)"}}>
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .tab{transition:.15s;cursor:pointer;border:none;font-family:inherit;white-space:nowrap}.tab:hover{opacity:.8}
        .ghost{border:none;background:transparent;cursor:pointer;font-family:inherit;transition:.15s}.ghost:hover{opacity:.65}
        .cat-pill{transition:.15s;cursor:pointer;border:none;font-family:inherit}.cat-pill:hover{opacity:.8}
        ...
        .store-tog{transition:.2s;cursor:pointer;user-select:none}.store-tog:hover{opacity:.85}
        .preset-btn{transition:.15s;cursor:pointer;border:none;font-family:inherit;text-align:left}
        .preset-btn:hover{background:#ede0ce!important;transform:scale(1.02)}
        ...
        select{border:1px solid #ede0ce;border-radius:8px;padding:.3rem .5rem;font-family:Lato;font-size:.82rem;color:#5a4030;background:white;outline:none;cursor:pointer}
        ::-webkit-scrollbar{height:4px;width:4px}::-webkit-scrollbar-thumb{background:#e0d0c0;border-radius:4px}
      `}</style>

      {/* HEADER */}
      <div style={{background:"white",borderBottom:"1px solid #ede0ce",position:"sticky",top:0,zIndex:10,boxShadow:"0 2px 12px rgba(90,60,30,.06)"}}>
        <div style={{maxWidth:660,margin:"0 auto",padding:"1rem 1.2rem .65rem"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:".65rem"}}>
            <div>
              <div style={{fontSize:".58rem",letterSpacing:"3.5px",color:"#b8a090",textTransform:"uppercase",marginBottom:".1rem"}}>Liste partagée</div>
          ...
          <div style={{display:"flex",gap:".4rem",overflowX:"auto",paddingBottom:".1rem"}}>
            <button className="tab" onClick={() => setTab("overview")} style={{background:tab==="overview"?"#3d2b1f":"#f5ede3",color:tab==="overview"?"white":"#7a5c40",borderRadius:20,padding:".3rem .85rem",fontSize:".78rem",fontWeight:tab==="overview"?700:400,boxShadow:tab==="overview"?"0 3px 10px rgba(61,43,31,.28)":"none"}}><IEye/> Vue d'ensemble</button>
            {data.stores.map(s => (
              <button key={s.id} className="tab" onClick={() => setTab(s.id)} style={{background:tab===s.id?s.color:"#f5ede3",color:tab===s.id?"white":"#7a5c40",borderRadius:20,padding:".3rem .85rem",fontSize:".78rem",fontWeight:tab===s.id?700:400,boxShadow:tab===s.id?`0 3px 10px ${s.color}55`:"none"}}>{s.icon} {s.name}</button>
            ))}
            <button className="tab" onClick={() => setShowAddStore(true)} style={{background:"#f5ede3",color:"#b8a090",borderRadius:20,padding:".3rem .72rem",fontSize:".78rem"}}>+ Magasin</button>
            <button className="tab" onClick={() => setTab("notes")} style={{background:tab==="notes"?"#5f4a38":"#f5ede3",color:tab==="notes"?"white":"#7a5c40",borderRadius:20,padding:".3rem .85rem",fontSize:".78rem",marginLeft:"auto",fontWeight:tab==="notes"?700:400}}><INote/> Notes</button>
          </div>
        </div>
      </div>
      ...
      <div style={{maxWidth:660,margin:"0 auto",padding:"1.4rem 1.2rem 6rem"}}>
        ...
        {/* ADD FORM */}
        {tab !== "notes" && (
          <div className="up" style={{background:"white",borderRadius:18,border:"1px solid #ede0ce",boxShadow:"0 4px 20px rgba(90,60,30,.08)",marginBottom:"1.4rem",overflow:"hidden"}}>
            {/* Categories */}
            <div style={{padding:".82rem 1.2rem .62rem",borderBottom:"1px solid #f5ede3"}}>
              <div style={{fontSize:".57rem",letterSpacing:"2px",textTransform:"uppercase",color:"#b8a090",marginBottom:".38rem"}}>Catégorie</div>
              <div style={{display:"flex",flexWrap:"wrap",gap:".26rem"}}>
                {CATS.map(c => (
                  <button key={c} className="cat-pill" onClick={() => { setItemCat(c); setSearch(""); }} style={{background:itemCat===c?"#3d2b1f":"#f5ede3",color:itemCat===c?"white":"#7a5c40",borderRadius:20,padding:".18rem .58rem",fontSize:".72rem",fontWeight:itemCat===c?700:400}}>{c}</button>
                ))}
              </div>
            </div>
            ...
            <div style={{padding:".7rem 1.2rem .55rem",borderBottom:"1px solid #f5ede3"}}>
              <div style={{fontSize:".57rem",letterSpacing:"2px",textTransform:"uppercase",color:"#b8a090",marginBottom:".38rem"}}>Acheter à…</div>
              <div style={{display:"flex",flexWrap:"wrap",gap:".42rem"}}>
                {data.stores.map(s => {
                  const on = !!itemStores[s.id];
                  return (
                    <div key={s.id} className="store-tog" onClick={() => setItemStores(p => ({...p,[s.id]:!p[s.id]}))} style={{display:"flex",alignItems:"center",gap:".4rem",background:on?s.color+"15":"#f5ede3",border:`2px solid ${on?s.color:"#e0d0c0"}`,borderRadius:20,padding:".26rem .78rem",transition:".18s"}}>
                      ...
                      <span style={{fontSize:".78rem",fontWeight:on?700:400,color:on?s.color:"#7a5c40",transition:".18s"}}>{s.icon} {s.name}</span>
                    </div>
                  );
                })}
              </div>
            ...
            {/* Text + qty + submit */}
            <div style={{padding:".78rem 1.2rem"}}>
              <div style={{display:"flex",alignItems:"center",gap:".6rem",flexWrap:"wrap"}}>
                <input ref={inputRef} className="inp" placeholder="Nom de l'article…" value={itemText} onChange={e => setItemText(e.target.value)} onKeyDown={e => e.key==="Enter"&&addItem()} style={{flex:"1 1 160px",fontSize:".95rem",minWidth:0}}/>
                <div style={{display:"flex",alignItems:"center",gap:".3rem",background:"#f8f2ea",borderRadius:10,padding:".3rem .55rem",flexShrink:0}}>
                  <input type="number" min="0" step="0.1" value={itemQty} onChange={e => setItemQty(e.target.value)} style={{width:48,border:"none",background:"transparent",outline:"none",fontFamily:"Lato",fontSize:".88rem",color:"#3d2b1f",textAlign:"center"}}/>
                  <select value={itemUnit} onChange={e => setItemUnit(e.target.value)} style={{border:"none",background:"transparent",fontSize:".8rem",color:"#7a5c40",outline:"none",cursor:"pointer",fontFamily:"Lato",maxWidth:90}}>
                    {UNITS.map(u => <option key={u} value={u}>{u}</option>)}
                  </select>
                </div>
                <button onClick={() => addItem()} style={{background:"#3d2b1f",color:"white",border:"none",borderRadius:12,width:40,height:40,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",fontSize:"1.2rem",flexShrink:0,boxShadow:"0 3px 10px rgba(61,43,31,.28)"}}><IPlus/></button>
              </div>
            </div>
          </div>
        )}
        ...
        {tab==="overview" && (
          <div className="up">
            ...
            {!data.items.length && <div style={{textAlign:"center",padding:"3rem",color:"#c4ad97",fontStyle:"italic",fontWeight:300}}>Ajoutez vos premiers articles ci-dessus…</div>}
          </div>
        )}
            ...
            {[...data.notes].reverse().map(note => {
              ...
              return (
                <div key={note.id} className="note-card" style={{background:"white",borderRadius:14,border:"1px solid #ede0ce",padding:".9rem 1.2rem",marginBottom:".58rem",boxShadow:"0 2px 10px rgba(90,60,30,.06)",display:"flex",gap:".72rem",alignItems:"flex-start"}}>
                  ...
                  <span className="del" onClick={() => deleteNote(note.id)} style={{color:"#d4a89a",fontSize:".9rem",flexShrink:0}}><ITrash/></span>
                </div>
              );
            })}
          </div>
...
function ItemRow({ item, storeId, storeColor, onToggle, onDelete }) {
  ...
  return (
    <div className="row" style={{display:"flex",alignItems:"center",gap:".72rem",background:done?"transparent":"white",borderRadius:12,padding:".65rem 1rem",marginBottom:".28rem",boxShadow:done?"none":"0 2px 10px rgba(90,60,30,.06)",border:done?"none":"1px solid #ede0ce",opacity:done?.47:1,transition:"all .2s"}}>
      <div className="chk" onClick={() => onToggle(item.id, storeId)} style={{width:21,height:21,borderRadius:6,flexShrink:0,border:done?"none":`2px solid ${storeColor}88`,background:done?storeColor:"transparent",color:"white",display:"flex",alignItems:"center",justifyContent:"center",fontSize:".7rem"}}>{done&&<ICheck/>}</div>
      <span style={{flex:1,color:"#3d2b1f",fontWeight:300,textDecoration:done?"line-through":"none",fontStyle:done?"italic":"normal",fontSize:".91rem"}}>{item.text}</span>
      ...
      {item.stores.length>1 && <span style={{fontSize:".6rem",color:"#b8a090",border:"1px solid #e5d5c0",borderRadius:8,padding:".08rem .36rem",whiteSpace:"nowrap",flexShrink:0}}>×{item.stores.length}</span>}
